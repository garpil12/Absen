...
register_font(client)        # ✅  WAJIB (font lu biar jalan)
register_help(client)
register_start(client)       # ✅  BIAR /start HIDUP
...
""",
                    ...
                    try:
                        cur.execute("INSERT INTO rekap VALUES (?,?,?,?,?)",
                                    (gid, today_str, hadir, izin, sakit))
                    except:
                        pass
                    ...
                    # 🔥 buat pesan absen baru + auto pin
                    try:
